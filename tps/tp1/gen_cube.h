...
Mesh create_mesh(Point p, float x_size, float y_size, float z_size) {
    ...
    //                                          0                                                   1         
    float pt[8][3] = { {-x_offset + p.x,-y_offset + p.y,-z_offset + p.z}, {x_offset + p.x,-y_offset + p.y,-z_offset + p.z},
    //                                          2                                                   3
                        {x_offset + p.x, -y_offset + p.y, z_offset + p.z}, {-x_offset + p.x, -y_offset + p.y, z_offset + p.z},
    //                                          4                                                   5
                        {-x_offset + p.x, y_offset + p.y, -z_offset + p.z}, {x_offset + p.x, y_offset + p.y, -z_offset + p.z},
    //                                          6                                                   7
                        {x_offset + p.x, y_offset + p.y, z_offset + p.z}, {-x_offset + p.x, y_offset + p.y, z_offset + p.z} };
